...
<body>    
    ...
    <!-- Navbar colosed -->
      ...
      <div class="row mt-5" >
        ...
        <div class="col-sm-2">
           <img src="image/1.jpg" height="300" width="300" class="img-fluid">
        </div>
        <div class="col-sm-2">
            <img src="image/2.jpg" height="300" width="300" class="img-fluid">
         </div>
         <div class="col-sm-2">
            <img src="image/3.jpg" height="300" width="300" class="img-fluid">
         </div>
         <div class="col-sm-2">
            <img src="image/4.jpg" height="300" width="300" class="img-fluid">
         </div>
         <div class="col-sm-2">
            <img src="image/6.jpg" height="300" width="300" class="img-fluid">
         </div>
        <div class="col-sm-1"></div>
      </div>
   <!-- ******************************************-->
         ...
         <div class="row mt-3" >
            <div class="col-sm-1"></div>
            <div class="col-sm-2">
               <img src="image/7.jpg" height="300" width="300" class="img-fluid">
            </div>
            <div class="col-sm-2">
                <img src="image/8.jpg" height="300" width="300" class="img-fluid">
             </div>
             <div class="col-sm-2">
                <img src="image/9.jpg" height="300" width="300" class="img-fluid">
             </div>
             <div class="col-sm-2">
                <img src="image/10.jpg" height="300" width="300" class="img-fluid">
             </div>
             <div class="col-sm-2">
                <img src="image/11.jpg" height="300" width="300" class="img-fluid">
             </div>
            <div class="col-sm-1"></div>
          </div>
       <!-- ******************************************-->
      ...
      <div class="row mt-3" >
        <div class="col-sm-1"></div>
        <div class="col-sm-2">
           <img src="image/12.jpg" height="300" width="300" class="img-fluid">
        </div>
        <div class="col-sm-2">
            <img src="image/13.jpg" height="300" width="300" class="img-fluid">
         </div>
         <div class="col-sm-2">
            <img src="image/14.jpg" height="300" width="300" class="img-fluid">
         </div>
         <div class="col-sm-2">
            <img src="image/15.jpg" height="300" width="300" class="img-fluid">
         </div>
         <div class="col-sm-2">
            <img src="image/15.jpg" height="300" width="300" class="img-fluid">
         </div>
   ...
   <!-- ******************************************-->
         ...
         <div class="row mt-3" >
            <div class="col-sm-1"></div>
            <div class="col-sm-2">
               <img src="image/16.jpg" height="300" width="300" class="img-fluid">
            </div>
            <div class="col-sm-2">
                <img src="image/17.jpg" height="300" width="300" class="img-fluid">
             </div>
             <div class="col-sm-2">
                <img src="image/18.jpg" height="300" width="300" class="img-fluid">
             </div>
             <div class="col-sm-2">
                <img src="image/19.jpg" height="300" width="300" class="img-fluid">
             </div>
             <div class="col-sm-2">
                <img src="image/20.jpg" height="300" width="300" class="img-fluid">
             </div>
            <div class="col-sm-1"></div>
          </div>
       <!-- ******************************************-->
      ...
      <div class="row mb-5 mt-3" >
        <div class="col-sm-1"></div>
        <div class="col-sm-2">
           <img src="image/21.jpeg" height="300" width="300" class="img-fluid">
        </div>
        <div class="col-sm-2">
            <img src="image/22.jpeg" height="300" width="300" class="img-fluid">
         </div>
         <div class="col-sm-2">
            <img src="image/23.jpeg" height="300" width="300" class="img-fluid">
         </div>
         <div class="col-sm-2">
            <img src="image/24.jpg" height="300" width="300" class="img-fluid">
         </div>
         <div class="col-sm-2">
            <img src="image/25.jpg" height="300" width="300" class="img-fluid">
         </div>
        <div class="col-sm-1"></div>
      </div>
   <!-- ******************************************-->
