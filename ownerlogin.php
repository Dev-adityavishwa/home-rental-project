<?php
  if(isset($_POST['login']))
 {
  ...
  $stmt = $con->prepare("INSERT INTO ownerlogin(`email_address`, `password`) VALUES (?, ?)");
...
<body>    
    ...
    <div class="row my-5">
      ...
      <div class="col-sm-4 py-5 shadow px-4 fw-bolder">
        <!-- FORM CREATE HERE  -->
        <h3 class="text-center websitecolor">OWNER LOGIN </h3><br>
        <form action="ownerlogin.php" method="Post" >
          ...
          <button type="submit" class="btn btn-secondary websitecolor w-100"  name="login">Log in</button><br>
          <a href="forgetpassword.php"><span>Forget Password</span></a>/
          <a href="ownerregistration.php"><span>Register</span></a>
        </form>
      </div>
      <div class="col-sm-4"></div>
    </div>
