...
<body>    
                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active fw-bold" href="changepassword.php"><span>CHANGE PASSOWRD</span></a>
                      </li>
                      <li class="nav-item">
    ...
    <div class="row py-4">
      ...
      <div class="col-sm-6 py-5 shadow rounded px-4 fw-bolder">
        ...
        <form action="">
            Enter Email Address:
            <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Emai Address" aria-describedby="emailHelp">
            Enter New password: <br>
            <input type="password" class="form-control" placeholder="Enter Password" name="password">
            Confirm  New Password: <br>
            <input type="password" class="form-control" placeholder="Confirm Password" name="confirmpassword"><br>
            <button type="submit" class="btn btn-outline btn-outline-secondary websitecolor w-100">Submit</button>  
        </form>
      </div>
      <div class="col-sm-3"></div>
    </div>
