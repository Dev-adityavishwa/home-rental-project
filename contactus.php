<?php
  if(isset($_POST['submit']))
 {
  ...
  $mobnum=$_POST["mobnum"];
  $enqtext=$_POST["enqtext"];
  $stmt = $con->prepare("INSERT INTO contact(`name`, `gender`, `address`, `mobile_number`, `enquiry_text`) VALUES (?, ?, ?, ?, ?)");
 $stmt->bind_param("sssis", $name, $gender, $address, $mobnum, $enqtext);
 $res = $stmt->execute();
 if ($res)
  {
...
<body>    
                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active fw-bold" href="gallery.php"> <span>GALLARY</span></a>
                      </li>                            
                    </ul>
    ...
    <div class="row my-5">
      ...
      <div class="col-sm-6 py-5 shadow  rounded px-4 fw-bolder">
        <h3 class="text-center websitecolor">CONTACT US FOR ANY QUIRY</h3>
        <!-- FORM CREATE HERE  -->
        <form action="contactus.php" method="post">
            ...
            <input type="number" class="form-control" placeholder="Enter Mobile Number" name="mobnum">
             Enquiry Text:
             <input type="textarea" class="form-control" placeholder="Enter Quiry Text" name="enqtext">
            <br>
