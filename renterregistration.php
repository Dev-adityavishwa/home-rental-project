<?php
  if(isset($_POST['submit']))
 {
  ...
  $stmt= $con->prepare("INSERT INTO renterregistration (`name`, `gender`, `address`, `email`, `mobile_number`, `aadhar_number`, `password` ) VALUES (?, ?, ?, ?, ?, ?, ?)");
...
<body>    
    ...
    <div class="row py-5">
      ...
      <div class="col-sm-6 py-5 shadow rounded px-5 fw-bolder">
        <h3 class="text-center websitecolor ">RENTER REGISTRATION </h3>
      <form action="renterregistration.php" method="POST"> 
        ...
        Confirm password: <br>
        <input type="password" class="form-control" placeholder="Confirm Password" name="confirmpass"> <br>
        <button type="submit" class="btn btn-secondary websitecolor w-100" name="submit">Submit</button>
